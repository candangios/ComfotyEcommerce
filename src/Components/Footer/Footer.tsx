          ...
          <div className="grid grid-cols-4">
            ...
            <div>
              ...
              <div className="footer_social flex items-center gap-3">
                <Link className="p-3 rounded-full border-[#007580] inline-block border-[1px]" to={""}><Facebook size='1.5rem' color="#007580" /></Link>


                <Link className="p-3 inline-block" to={""}><Twitter size='1.5rem' color="#007580" /></Link>


                <Link className="p-3 inline-block" to={""}><Instagram size='1.5rem' color="#007580" /></Link>


                <Link className="p-3 inline-block" to={""}><Youtube size='1.5rem' color="#007580" /></Link>
              </div>
            </div>
            ...
            <div className="footer_wrapper">
              ...
              <ul className="space-y-2 mt-4">
                <li><Link className="text-base text-[#272343] font-inter font-normal capitalize" to={""}>sofa</Link></li>
                <li><Link className="text-base text-[#272343] font-inter font-normal capitalize" to={""}>armchair</Link></li>
                <li><Link className="text-base text-[#272343] font-inter font-normal capitalize" to={""}>wing chair</Link></li>
                <li><Link className="text-base text-[#272343] font-inter font-normal capitalize" to={""}>desk chair</Link></li>
                <li><Link className="text-base text-[#272343] font-inter font-normal capitalize" to={""}>wooden chair</Link></li>
                <li><Link className="text-base text-[#272343] font-inter font-normal capitalize" to={""}>park bench</Link></li>
              </ul>
            </div>
            ...
            <div className="footer_wrapper">
              ...
              <ul className="space-y-2 mt-4">
                <li><Link className="text-base text-[#272343] font-inter font-normal capitalize" to={""}>help & support</Link></li>
                <li><Link className="text-base text-[#272343] font-inter font-normal capitalize" to={""}>tearms & condition</Link></li>
                <li><Link className="text-base text-[#272343] font-inter font-normal capitalize" to={""}>privacy policy</Link></li>
                <li><Link className="text-base text-[#272343] font-inter font-normal capitalize" to={""}>help</Link></li>
              </ul>
            </div>
